...
**Status:** 🟢 · **Branch:** `cart/02-inventory` (stacked on #5 → #4) · **Current feature:** `cart/02-inventory`, built and hand-checked, PR #6 · `cart/01-movement` in PR #4 · **Updated:** 2026-09-24 (Rickey, Claude Code)
