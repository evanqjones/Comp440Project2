...
```text
Context: <System> feature <NN-slug>. Read AGENTS.md, 01-spec.md §<n>, and CONTRACTS.md §<n>.
...
commit "<system>: test scene for <NN-slug>", and list the hand checks from 01-spec.md §7.
```
